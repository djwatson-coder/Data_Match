...
class BflExcelReader(ExcelReader):
    ...
    def read_file(self, file_path: str):
        ...
        elif "Bordereaux" in xl.sheet_names:
            df = self.read_type_file(file_path, sheet="Bordereaux")
        elif "AON Municipalities" in xl.sheet_names:
            df = self.read_type_file(file_path, sheet="AON Municipalities")
        else:
